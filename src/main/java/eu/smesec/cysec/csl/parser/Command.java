...
public abstract class Command {
  ...
  public static void registerCommands() {
    ...
    registerCommand("and", new CommandAbstractBoolOp.CommandAnd());
    registerCommand("or", new CommandAbstractBoolOp.CommandOr());
    registerCommand("not", new CommandAbstractBoolOp.CommandNot());
    registerCommand("xor", new CommandAbstractBoolOp.CommandXor());
    registerCommand("equals", new CommandEquals());
    registerCommand("greaterThan", new CommandNumberBinaryPredicate.CommandGreaterThan());
    registerCommand("greaterThanOrEq", new CommandNumberBinaryPredicate.CommandGreaterThanOrEquals());
    registerCommand("lowerThan", new CommandNumberBinaryPredicate.CommandLowerThan());
    registerCommand("lowerThanOrEq", new CommandNumberBinaryPredicate.CommandLowerThanOrEquals());
