...
public class TestScoreFactory {
    ...
    public void testBasicFunctionality() {
        ...
        assertTrue(
                "value of score test2 is bad (2; should:2; is:"
                        + context.getScore("test1").getValue() + ")",
                context.getScore("test2").getValue() == 2);
        ...
        assertTrue(
                "value of score test1 is bad (4; should:6; is:" + context.getScore("test1") + ")",
                context.getScore("test1").getValue() == 6);
        ...
        assertTrue(
                "value of score test1 is bad (5; should:2; is:" + context.getScore("test1") + ")",
                context.getScore("test1").getValue() == 2);
        ...
        assertTrue(
                "value of score before reversion test1 is bad (6; should:6; is:"
                        + context.getScore("test1").getValue() + ")",
                context.getScore("test1").getValue() == 6);
        context.revertQuestionScore("qid2");
        assertTrue(
                "value of score after reversion test1 is bad (6; should:4; is:"
                        + context.getScore("test1").getValue() + ")",
                context.getScore("test1").getValue() == 4);
    }
}
