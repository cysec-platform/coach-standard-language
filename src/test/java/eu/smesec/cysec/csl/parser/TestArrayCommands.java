...
public class TestArrayCommands extends AbstractTestCommands {
    ...
    public static Map<String, List<String>> m = Map.ofEntries(Map.entry("100, 100", Arrays.asList("100", "100")));
    ...
    public void testSimpleArrayAdd() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    ...
                    "100, 200, 100",
                    context.getVariable("arr", null).getId());
            assertEquals(
                    "unexpected Value in Array",
                    "100, 200, 100, 100",
                    context.getVariable("arr2", null).getId());
        } catch (Exception pe) {
            pe.printStackTrace();
    ...
    public void testSimpleArrayRemove() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    ...
                    context.getVariable("arr", null).getId());
            assertEquals(
                    "unexpected Value in first tempArray",
                    "100, 100, 200",
                    context.getVariable("arr2", null).getId());
        } catch (Exception pe) {
            pe.printStackTrace();
    ...
    public void testSimpleArrayContains() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    ...
                    context.getVariable("arr", null).getId());
            assertEquals(
                    "visible value found in Array",
                    "TRUE",
                    context.getVariable("to1", null).getId());
            assertEquals(
                    "nonexisting value unexpectedly found in Array",
                    null,
                    context.getVariable("to2", null).getId());
        } catch (Exception pe) {
            pe.printStackTrace();
            fail("got unexpected exception " + pe);
        }
    ...
    public void testSimpleArrayElements() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    ...
                    context.getVariable("arr", null).getId());
            assertEquals(
                    "Number of array elements missmatch (1)",
                    "TRUE",
                    context.getVariable("to1", null).getId());
            assertEquals(
                    "Number of array elements missmatch (2)",
                    null,
                    context.getVariable("to2", null).getId());
            assertEquals(
                    "Number of array elements missmatch (3)",
                    null,
                    context.getVariable("to3", null).getId());
            assertEquals(
                    "Number of array elements missmatch (4)",
                    "TRUE",
                    context.getVariable("to4", null).getId());
            assertEquals(
                    "Number of array elements missmatch (5)",
                    "TRUE",
                    context.getVariable("to5", null).getId());
        } catch (Exception pe) {
            pe.printStackTrace();
            fail("got unexpected exception " + pe);
        }
