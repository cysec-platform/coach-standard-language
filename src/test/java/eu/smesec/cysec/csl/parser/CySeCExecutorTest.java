...
public class CySeCExecutorTest {
    ...
    public void setup() {
        ...
        coachContext = new CoachContext(
                CySeCExecutorContextFactory.getExecutorContext("testCoach"), cal, question, null, null, null);
    ...
    public void basicExecutorTest() {
        try {
            ...
            sb.append("TRUE : always1 : set(\"always1\",\"is set\"); // this line is always executed"
                    + System.lineSeparator());
            sb.append("TRUE : always1 : set(\"always1\",\"is set for the second time\"); // this line is never executed"
                    + System.lineSeparator());
            sb.append("FALSE : never : set(\"always2\",\"is set\"); // this line is always executed"
                    + System.lineSeparator());
            ...
            assertTrue(
                    "always1 has not been executed",
                    "is set".equals(context.getVariable("always1", null).getId()));
            assertTrue("never has been executed", context.getVariable("never", null) == NULL_ATOM);
            assertTrue(
                    "the next id is not set properly",
                    "qid2".equals(context.getVariable("_coach.nextPage", null).getId()));
        } catch (Exception pe) {
            pe.printStackTrace();
    ...
    public void executorInheritanceTest() {
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("TRUE : always1 : root.set(\"always1\",\"is set\"); // this line is always executed"
                    + System.lineSeparator());
            sb.append(
                    "TRUE : always1 : root.set(\"always1\",\"is set for the second time\"); // this line is never executed"
                            + System.lineSeparator());
            sb.append("TRUE : always2 : parent.set(\"always2\",\"is set\"); // this line is always executed"
                    + System.lineSeparator());
            sb.append(
                    "TRUE : always2 : parent.set(\"always2\",\"is set for the second time\"); // this line is never executed"
                            + System.lineSeparator());
            sb.append("FALSE : never : root.set(\"always2\",\"is set\"); // this line is always executed"
                    + System.lineSeparator());
            sb.append("TRUE : stack : { // this stack is always executed" + System.lineSeparator());
            sb.append("                 setNext(\"qid2\");" + System.lineSeparator());
            sb.append("               };" + System.lineSeparator());
            ...
            assertTrue(
                    "always1 has not been executed",
                    "is set".equals(tcontext.getVariable("always1", null).getId()));
            assertTrue("never has been executed", tcontext.getVariable("never", null) == NULL_ATOM);
            assertTrue(
                    "always2 has not been executed",
                    "is set".equals(icontext.getVariable("always2", null).getId()));
            assertTrue(
                    "the next id is not set properly",
                    "qid2".equals(context.getVariable("_coach.nextPage", null).getId()));
        } catch (Exception pe) {
    ...
    public void variableStackTest() {
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("TRUE : always1 : root.set(\"always1\",\"a\"); // this line is always executed"
                    + System.lineSeparator());
            sb.append("TRUE : always2 : root.set(\"always1\",\"b\"); // this line is as well executed"
                    + System.lineSeparator());
            List<CySeCLineAtom> lines = new ParserLine(sb.toString()).getCySeCListing();
            ExecutorContext context = CySeCExecutorContextFactory.getExecutorContext("testCoach");
            context.executeQuestion(lines, coachContext);
            ...
            assertTrue(
                    "always1 has not correct cintent (is: "
                            + tcontext.getVariable("always1", null).getId() + ")",
                    "b".equals(tcontext.getVariable("always1", null).getId()));
        } catch (Exception pe) {
            pe.printStackTrace();
            fail("got unexpected exception");
        }
